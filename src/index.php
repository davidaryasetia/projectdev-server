    ...
    <head>
        ...
        <meta name="keywords"
            content="david, david aryasetia, david aryasetia febrian, david aryasetia febrian susanto" />
    ...
    <body>
        <div class="container">
            ...
            <div class="stat-section">
                ...
                <p><span>Memory Total Usage:</span>
                    <?php
                    $meminfo = file_get_contents("/proc/meminfo");
                    preg_match("/MemTotal:\s+(\d+)/", $meminfo, $matches_total);
                    preg_match("/MemAvailable:\s+(\d+)/", $meminfo, $matches_free);

                    $total = round($matches_total[1] / 1024 / 1024, 2);
                    $free = round($matches_free[1] / 1024 / 1024, 2);
                    $used = $total - $free;

                    echo "{$used} GB used of {$total} GB (Free: {$free} GB)";
                    ?>
                </p>
